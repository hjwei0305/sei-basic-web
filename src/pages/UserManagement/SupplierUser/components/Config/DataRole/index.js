...
class DataRoleModal extends PureComponent {
  ...
  assignDataRole = (keys, callback) => {
    ...
    dispatch({
      type: 'supplierUser/assignDataRole',
      payload: {
        ...data,
      },
      callback,
  ...
  unAssignDataRole = (keys, callback) => {
    ...
    const data = { parentId: get(currentSupplier, 'id', null), childIds: keys };
    dispatch({
      type: 'supplierUser/unAssignDataRole',
      payload: {
        ...data,
      },
      callback,
  ...
  handlerSaveEffectDate = (data, callback) => {
    ...
    dispatch({
      type: 'supplierUser/saveAssignDataRoleEffective',
      payload: {
        ...data,
      },
      callback,
  ...
  render() {
    ...
    const assignProps = {
      ...
      saving: loading.effects['supplierUser/assignDataRole'],
    };
    const assignedProps = {
      currentSupplier,
      onShowAssign: this.handlerShowAssign,
      save: this.unAssignDataRole,
      saving: loading.effects['supplierUser/unAssignDataRole'],
      onSaveEffectDate: this.handlerSaveEffectDate,
      effectDateSaving: loading.effects['supplierUser/saveAssignDataRoleEffective'],
    };
    return (

...
export default {
  ...
  "basic_000008":"the password must contain at least 2 kinds of letters, numbers and special characters, and the length of the password cannot be less than 8 digits",
  "basic_000009":"to ensure the security of your account, please fill in the original password before changing the password",
  ...
  "basic_000365":"please upload the icon for the application, the picture is in PNG format, the length and width of the picture are 44px, and the size is within 10KB",
